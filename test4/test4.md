...
-- QUOTAS
ALTER USER new_user_mx QUOTA UNLIMITED ON USERS;
ALTER USER new_user_mx QUOTA UNLIMITED ON USERS02;
ALTER USER new_user_mx ACCOUNT UNLOCK;

-- ROLES
GRANT "CONNECT" TO new_user_mx WITH ADMIN OPTION;
GRANT "RESOURCE" TO new_user_mx WITH ADMIN OPTION;
ALTER USER new_user_mx DEFAULT ROLE "CONNECT","RESOURCE";
